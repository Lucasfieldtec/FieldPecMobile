...
type
  TFrmLimpaBebedouro = class(TForm)
...
var
  FrmLimpaBebedouro: TFrmLimpaBebedouro;
...
procedure TFrmLimpaBebedouro.FormShow(Sender: TObject);
begin
 {$IFDEF ANDROID}
...
procedure TFrmLimpaBebedouro.FrameGesture(Sender: TObject;
  const EventInfo: TGestureEventInfo; var Handled: Boolean);
begin
  layBtnLista.Visible := true;
end;

procedure TFrmLimpaBebedouro.FrameMouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
  TFrame(sender).Opacity := 0.5;
end;

procedure TFrmLimpaBebedouro.FrameMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
  TFrame(sender).Opacity := 1;
end;

procedure TFrmLimpaBebedouro.GeraListaCards(vFiltro: string);
var
  item: TListBoxItem;
begin
...
procedure TFrmLimpaBebedouro.ItemClick(Sender: TObject);
begin
...
procedure TFrmLimpaBebedouro.SearchEditButton2Click(Sender: TObject);
begin
...
procedure TFrmLimpaBebedouro.btnBuscarClick(Sender: TObject);
var
 vFiltro:string;
begin
...
procedure TFrmLimpaBebedouro.btnCloseAllClick(Sender: TObject);
begin
 Close;
end;

procedure TFrmLimpaBebedouro.btnConfirmarClick(Sender: TObject);
begin
...
procedure TFrmLimpaBebedouro.btnExcluiItemClick(Sender: TObject);
begin
 layBtnLista.Visible := false;
 if vFlagSync='0' then
 begin
...
procedure TFrmLimpaBebedouro.btnLerQrClick(Sender: TObject);
var
 vCod,vNome:string;
begin
 {$IFDEF Android}
...
procedure TFrmLimpaBebedouro.btnNovoClick(Sender: TObject);
begin
...
procedure TFrmLimpaBebedouro.btnNovoMouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Single);
begin
     TRectangle(sender).Opacity := 0.5;
end;

procedure TFrmLimpaBebedouro.btnNovoMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Single);
begin
     TRectangle(sender).Opacity := 1;
end;

procedure TFrmLimpaBebedouro.DestroiFrames;
var
  i : Integer;
begin
